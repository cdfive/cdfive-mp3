...
<head>
    <meta charset="UTF-8">
    <title>系统错误</title>
    <link rel="shortcut icon" href="/static/image/public/favicon.ico" type="image/x-icon" />
    <link href="/static/css/error.css" rel="stylesheet" media="screen" type="text/css" />
</head>
<body>
    ...
    <div style="text-align:center;clear:both">
		...
		<span id="s" style="color:red;">10</span>秒跳转到<a href="/">登录页</a></p>
	</body>
	<script type="text/javascript" src="/static/plugin/jquery/jquery.1.10.2.js" charset="utf-8"></script>
	<script>
		function foo() {
			setTimeout(function(){
	            var s = $("#s").text();

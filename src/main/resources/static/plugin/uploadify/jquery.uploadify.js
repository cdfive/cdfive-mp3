...
SWFUpload.Console.writeLine = function (d) {
    ...
    try {
        ...
        console.log("Exception: " + c.name + " Message: " + c.message)
    }
};
    ...
    var handlers = {
        ...
        onUploadError: function (file, errorCode, errorMsg) {
            ...
            if ($.inArray('onUploadError', settings.overrideEvents) < 0) {
                ...
                if (file && errorCode != SWFUpload.UPLOAD_ERROR.FILE_CANCELLED && errorCode != SWFUpload.UPLOAD_ERROR.UPLOAD_STOPPED) {
                ...
                if (file && errorCode != SWFUpload.UPLOAD_ERROR.SPECIFIED_FILE_ID_NOT_FOUND && file.status != SWFUpload.FILE_STATUS.COMPLETE) {
        ...
        onUploadProgress: function (file, fileBytesLoaded, fileTotalBytes) {
            ...
            if ($.inArray('onUploadProgress', settings.overrideEvents) < 0) {
                if (settings.progressData == 'percentage') {
                    ...
                    //console.log(this.queueData.averageSpeed,'this.queueData.averageSpeed')
                }
                $('#' + file.id).find('.uploadify-progress-bar').css('width', percentage + '%');
            }

            // Call the user-defined event handler
            if (settings.onUploadProgress) settings.onUploadProgress.call(this, file, fileBytesLoaded, fileTotalBytes, queueBytesLoaded, this.queueData.uploadSize, percentage);
        },
